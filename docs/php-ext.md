...
| Platform    | Release                                                                                                                                                      |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Linux (x64) | [`santa-lang-comet-php-0.0.10-linux-amd64.so`](https://github.com/eddmann/santa-lang-rs/releases/download/0.0.10/santa-lang-comet-php-0.0.10-linux-amd64.so) |
