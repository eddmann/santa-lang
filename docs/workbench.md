...
| Platform      | Download                                                                                                                                                           |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| macOS (ARM)   | [`santa-workbench-0.1.2-macos-arm64.dmg`](https://github.com/eddmann/santa-lang-workbench/releases/download/0.1.2/santa-workbench-0.1.2-macos-arm64.dmg)           |
| macOS (Intel) | [`santa-workbench-0.1.2-macos-amd64.dmg`](https://github.com/eddmann/santa-lang-workbench/releases/download/0.1.2/santa-workbench-0.1.2-macos-amd64.dmg)           |
| Linux (x64)   | [`santa-workbench-0.1.2-linux-amd64.deb`](https://github.com/eddmann/santa-lang-workbench/releases/download/0.1.2/santa-workbench-0.1.2-linux-amd64.deb)           |
| Linux (x64)   | [`santa-workbench-0.1.2-linux-amd64.AppImage`](https://github.com/eddmann/santa-lang-workbench/releases/download/0.1.2/santa-workbench-0.1.2-linux-amd64.AppImage) |
